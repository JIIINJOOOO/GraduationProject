...
{
	CLOSE_RANGE_START = 0, NORMAL_ATTACK, HANDCLAP_ATTACK, SWEEP_ATTACK, PUNCH_ATTACK, STOMP_ATTACK, WALKING_ATTACK, CLOSE_RANGE_END, // Close Range
	LONG_RANGE_START = 8, RUSH_ATTACK, THROW_STONE, THROW_SPEAR, LONG_RANGE_END,	// Long Range
	DOWN_START = 13, DOWN_ATTACK_1, DOWN_ATTACK_2, DOWN_END,		// Down State
